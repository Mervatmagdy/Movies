        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start,
          children: [
           ...
           Row(
            ...
            SizedBox(height:10,),
            Text('${widget.movie.title}',style:Theme.of(context).textTheme.titleSmall!.copyWith(color: MyTheme.whiteColor),),
            SizedBox(height:10,),
            Text(widget.movie.releaseDate!,style:Theme.of(context).textTheme.titleSmall!.copyWith(fontSize: 12,fontWeight:FontWeight.normal),)
          ],
        ),
      ),
    );
